    ...
    <div class="card bg-gradient-to-br from-blue-500 to-blue-600 text-white">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold mt-2">$<?php echo e(number_format($currentMonthRevenueUSD, 2)); ?></p>
            </div>
    ...
    <div class="card bg-gradient-to-br from-green-500 to-green-600 text-white">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold mt-2"><?php echo e(number_format($currentMonthRevenueIQD, 0)); ?></p>
            </div>
    ...
    <div class="card bg-gradient-to-br from-purple-500 to-purple-600 text-white">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold mt-2">$<?php echo e(number_format($currentMonthInstallmentsUSD, 2)); ?></p>
            </div>
    ...
    <div class="card bg-gradient-to-br from-orange-500 to-orange-600 text-white">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold mt-2"><?php echo e(number_format($currentMonthInstallmentsIQD, 0)); ?></p>
            </div>
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
    ...
    <div class="card">
        ...
        <p class="text-2xl font-bold text-green-600">$<?php echo e(number_format($totalRevenueUSD, 2)); ?></p>
        <p class="text-xl font-bold text-green-600 mt-1"><?php echo e(number_format($totalRevenueIQD, 0)); ?> IQD</p>
    </div>
</div>
