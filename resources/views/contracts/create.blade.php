        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <select id="app_name" name="app_name" class="input-field" required>
                    ...
                    <option value="Teami Pro" {{ old('app_name') == 'Teami Pro' ? 'selected' : '' }}>Teami Pro</option>
                    <option value="MaxCon" {{ old('app_name') == 'MaxCon' ? 'selected' : '' }}>MaxCon</option>
                    <option value="ConCure" {{ old('app_name') == 'ConCure' ? 'selected' : '' }}>ConCure</option>
                    <option value="MediCon" {{ old('app_name') == 'MediCon' ? 'selected' : '' }}>MediCon</option>
                    <option value="Connect Job" {{ old('app_name') == 'Connect Job' ? 'selected' : '' }}>Connect Job</option>
                </select>
                @error('app_name')
            ...
            <div>
                ...
                <input type="number" id="duration_months" name="duration_months" value="{{ old('duration_months') }}" 
            ...
            <div>
                ...
                <select id="installment_frequency" name="installment_frequency" class="input-field" required>
                    ...
                    <option value="monthly" {{ old('installment_frequency') == 'monthly' ? 'selected' : '' }}>Monthly</option>
                    <option value="quarterly" {{ old('installment_frequency') == 'quarterly' ? 'selected' : '' }}>Quarterly</option>
                    <option value="yearly" {{ old('installment_frequency') == 'yearly' ? 'selected' : '' }}>Yearly</option>
                </select>
